package com.example.sajan.geometriccalculator.shape.logic;


import com.example.sajan.geometriccalculator.shape.ui.OutputInterface;
...
public class Logic
    ...
    public static double boxSurfaceArea(double length, double width, double depth){
        ...
        return ((2*length*depth)+(2*width*depth));
    }
